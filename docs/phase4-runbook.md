...
Motivo: Fase 4 puede probarse en modo demo sin Supabase, pero la practica real necesita persistencia, usuarios, intentos y evaluacion definitiva. Si se posterga la integracion hasta el final, se acumula riesgo tecnico.
...
- Se muestra evaluacion demo por los 4 criterios de rubrica.
...
El endpoint real de evaluacion ya existe en:
...
- La evaluacion demo es heuristica local. No reemplaza la evaluacion con OpenAI.
- No persiste intentos todavia.
- No requiere login.
- La siguiente fase debe conectar practica real con usuario, sesiones e historial.
